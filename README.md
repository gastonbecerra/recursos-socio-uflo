...
Aquí linkeamos a nuestros proyectos de investigación (completos, con marco teórico, objetivos, antecedentes, bajada metodológica y presupuesto)

- [Proyecto: Indagaciones en torno a la Equidad de Género y Diversidad Sexual](https://docs.google.com/document/d/e/2PACX-1vQxlAOlzGBGe4lbRkex1X5yYnhtH-uVUE2PxY_0HOwrHCeed4gY5t_Sk0e489eymqYPY8l0dZbrmZzg/pub) / 2024 / Este proyecto pretende iniciar una línea de investigación que acompañe el trabajo del Programa de Equidad de Género y Diversidad Sexual, un espacio creado en 2023 que vincula todas las sedes, unidades, y dependencias de la Universidad de Flores (UFLO), y cuyo principal propósito es transversalizar la perspectiva de género y el paradigma de los Derechos Humanos para impulsar el avance y la efectivización de derechos de mujeres, disidencias y diversidades sexuales.

- [Proyecto: Recursos computacionales para investigación en torno a la Teoría de Sistemas Sociales (también llamado *DataLuhmann*)](https://docs.google.com/document/d/e/2PACX-1vQvnVTcjm8o7LkCWwTFlj7qp9A5kUIQz0od0M5Vv4VHxMNjWFInitI-tqs9GXz-EqhonNUxwkHnHW_p/pub) / 2023 / Este proyecto de investigación presentado adopta a la TSS y los trabajos de esta comunidad de distintas formas: como objeto de estudio, como marco teórico y como prisma heurístico. Metodológicamente nos situamos en las ciencias sociales computacionales, la revalorización del desarrollo de herramientas y recursos digitales abiertos, el interés por el desarrollo de conocimiento a través de análisis reproducibles y transparentes, y la promoción de espacios de diálogo transdisciplinarios que no descuiden la reflexión epistemológica.

- [Proyecto: Exploraciones empíricas y teóricas sobre problemáticas socio-tecnológicas en perspectiva psicosocial](https://docs.google.com/document/d/e/2PACX-1vQhdUFEWPUx4oEq9ambhQvsHAiii1YK-fJaoCNldkPY5N3Sb5CVGJcA5DJOwhUS6M_w9OA6oz8QiGi5/pub) / 2022 / El presente proyecto se propone indagar fenómenos socio-tecnológicos recientes, productos de los procesos sociales vinculados con la digitalización y datificación de diversas esferas de la vida subjetiva y social: (1) el big data, que presupone la disponibilidad de exhaustivas bases de datos que permiten modelar y predecir fenómenos y comportamientos, (2) la proliferación de algoritmos sociales, basados en distintas implementaciones de inteligencia artificial, con las que interactuamos y (3) las aplicaciones descentralizadas, como las de tecnología blockchain, entre las que se destacan las criptomonedas.

- [Proyecto: La Teoría de los Sistemas Sociales en las dicotomías de la sociología contemporánea](https://docs.google.com/document/d/e/2PACX-1vTccXsWLV5cYNQO62CM2dICtWI0sJshi2C_iVx3W9zu5E_x7WyJJxj9oxSoIHHyTR-PZTyYS9SADgde/pub) / 2022 / El presente proyecto, correspondiente al área de la teoría sociológica, busca contribuir a avanzar la elucidación de aspectos críticos y controversiales de la Teoría de los Sistemas Sociales (TSS) -iniciada por Niklas Luhmann entre las décadas del '70 y 90-, al ubicarla en 4 dicotomías que han marcado el pensamiento sociológico, a saber: acción/sistema, constituyente del campo sociológico; realismo/constructivismo, pertinente a los debates epistemológicos y ontológicos; teoría/empiria, vinculada con la división del trabajo intelectual en la disciplina; y descripción/crítica, centrada en la finalidad de la labor sociológica.
